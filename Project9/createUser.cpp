...
bool generate_key()   // Funksioni per gjenerimin e qelsave.
{
	...
	bp_public = BIO_new_file("C:\\Users\\ACER\\Desktop\\keys\\public.pem", "w+");   // Ketu e kemi rujatur qelsin publik.
	ret = PEM_write_bio_RSAPublicKey(bp_public, r);
	if (ret != 1) {
		goto free_all;
	}

	bp_private = BIO_new_file("C:\\Users\\ACER\\Desktop\\keys\\private.pem", "w+");   // Ketu e kemi rujatur qelsin privat.
...
void createUser() {
    ...
    if (allowedchars != name.length()) {
        ...
        string path = "C:\\Users\\ACER\\Desktop\\keys\\" + name + ".pem";   // E check-irat nese egziston ky file me kete emer.
        ifstream fin(path);
        ...
        if (fin.is_open()) {
			...
			string newpath = "C:\\Users\\ACER\\Desktop\\keys\\" + name + ".pub.pem";
			...
			string newpathprivate = "C:\\Users\\ACER\\Desktop\\keys\\" + name + ".pem";
			int j;
			...
			arrayprivate[j] = '\0';
			char oldpathprivate[] = "C:\\Users\\ACER\\Desktop\\keys\\private.pem";
